...
//  alert(canvas.position().top);
  ...
  function Node(xp, yp, w, h, noDelete, forceId){
   ...
   //append inheritance sign 'I'	
	n.append("<div class='i'>I<\/div>");
      var i = $(".node .i").last();
      i.css({"position":"absolute","padding-right" : 2, "padding-top" : 0, "padding-left" : 2,
              "color" : "white", "font-family" : "sans-serif",
              "top" : -1, "right": 2, "cursor": "pointer",
	...
	//append composition sign 'C'	
	n.append("<div class='c'>C<\/div>");
      var c = $(".node .c").last();
      c.css({"position":"absolute","padding-right" : 2, "padding-top" : 0, "padding-left" : 2,
              "color" : "white", "font-family" : "sans-serif",
              "top" : -1, "right": 10, "cursor": "pointer",
              "font-size" : "8px", "background-color" : "gray", "z-index" : 100});
      c.hover(function(){
        c.css("color","black");
      }, function(){
